                ...
                <div className="px-6 lg:px-20 flex flex-col lg:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <div class="social-button">
                            <a href="https://instagram.com/iam_ak._.__" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                        ...
                        <div class="social-button">
                        <a href="https://x.com/Pragatheesh_SOS" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                            <button class="relative w-12 h-12 rounded-full group">
                            <div
                        ...
                        <div class="social-button">
                        <a href="https://www.facebook.com/viswanathan.viswanathan.73594?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                            <button class="relative w-12 h-12 rounded-full group">
                            <div
                        ...
                        <div class="social-button">
                        <a href="https://youtube.com/@robinanbu2564" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                            <button class="relative w-12 h-12 rounded-full group">
                            <div
